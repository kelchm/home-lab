...
Convergence is complete: OpenObserve, Loki, and the kube-prometheus-stack Prometheus and Alertmanager are removed, leaving VictoriaMetrics for metrics, VictoriaLogs for logs, and VMAlertmanager as the sole notification authority. The remaining work — dashboard and estate coverage, and the anomaly/ML decision — is sequenced in [plans/20260703-observability-rework.md](plans/20260703-observability-rework.md).
